...
raw_fname = op.join(pwd, 'S9012_ses1_cond1_block0001-epo.fif') # eeg data name 

os.chdir(subjectDir+'\\'+ subjectName)
...
src1.plot(head=True,brain=False,skull=True,subjects_dir = subjectDir)
"""
...
brain = Brain(subjectName, 'rh', 'inflated', subjects_dir=subjectDir)
surf = brain.geo['rh']
...
epi_img = nib.load('AVG12-0Months3T_segmented_BEM3.nii.gz')
epi_img_data = epi_img.get_fdata()
epi_img_data.shape

ep = nib.load('ANTS1-0Months_brain.nii.gz')
"""
